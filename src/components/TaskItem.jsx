...
import { FaTrash, FaEdit, FaSave, FaTimes, FaClock, FaLock, FaLockOpen, FaPlay, FaPause, FaStop } from 'react-icons/fa';
      ...
      <div className="relative overflow-hidden rounded-2xl border-2 border-cyan-400/60 bg-gradient-to-br from-cyan-50 via-teal-50 to-orange-50 px-6 py-5 shadow-lg transition-transform duration-200 ease-out hover:-translate-y-0.5 hover:scale-[1.01] dark:border-amber-800/70 dark:bg-gradient-to-br dark:from-amber-950/40 dark:via-stone-950/60 dark:to-slate-950/40">
        ...
        <div className="relative space-y-4">
          <input
            ...
            className="w-full rounded-xl border-2 border-cyan-300/60 bg-white/90 px-4 py-3 text-base font-semibold text-slate-900 outline-none ring-cyan-500/60 transition-shadow duration-150 focus:ring-2 focus:shadow-md dark:border-amber-700/60 dark:bg-slate-900/80 dark:text-amber-50 dark:ring-amber-500/60"
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl border-2 border-cyan-300/60 bg-white/90 px-4 py-3 text-sm font-medium text-slate-900 outline-none ring-cyan-500/60 transition-shadow duration-150 focus:ring-2 focus:shadow-md dark:border-amber-700/60 dark:bg-slate-900/80 dark:text-amber-50 dark:ring-amber-500/60"
    ...
    >
      ...
      <div className="mt-5 flex justify-between gap-4">
        <div className="flex-1">
          ...
          {/* TIMER SECTION */}
          {task.estimatedDuration && task.status !== 'DONE' && (
          ...
          {/* Affichage du temps passé pour les tâches terminées */}
          ...
          {/* Barre de progression basée sur échéance */}
          {progressInfo && (
            <div className="mt-4">
          ...
          {/* Ancienne barre pour tâches sans durée */}
